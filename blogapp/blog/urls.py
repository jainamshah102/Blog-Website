...
from .views import new_blog, view_blog, like, view_drafts, view_published, publish_blog, delete_blog, edit_blog, view_draft_blog
...
urlpatterns = [
    ...
    path('draft_blog/<int:blog>/<slug:slug>', view_draft_blog, name='view_draft_blog'),
]
